...
public interface AsyncTaskService
        extends AuditedEntityService<AsyncTask, Long> {
    ...
    List<AsyncTask> listByResourceId(
            UUID resourceId,
            AsyncTaskStatus status,
            int page,
            int pageSize);
