...
public class TaskStatusHandler {
    ...
    public Map<String, Object> buildStatusMap(
            AsyncTask task, String baseApiPath) {
        ...
        status.put(
                "resource_id",
                task.getTaskResourceId() == null
                        ? ""
                        : task.getTaskResourceId().toString());
    ...
    public <T> Optional<T> deserializeResult(
            AsyncTask task, Class<T> targetType) {
