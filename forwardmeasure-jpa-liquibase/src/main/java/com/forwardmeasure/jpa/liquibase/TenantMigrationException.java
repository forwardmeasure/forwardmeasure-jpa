...
public final class TenantMigrationException extends RuntimeException {
  ...
  public TenantMigrationException(TenantSchema schema, Throwable cause) {
    this(schema, "migrate", cause);
  }

  public TenantMigrationException(TenantSchema schema, String operation, Throwable cause) {
