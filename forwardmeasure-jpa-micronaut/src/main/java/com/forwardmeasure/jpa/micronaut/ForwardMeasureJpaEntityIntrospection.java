...
/**
 * Generates Micronaut introspection metadata for the shared identity entities without introducing a
 * Micronaut dependency into the portable identity module.
 */
@Introspected(
    packages = {
