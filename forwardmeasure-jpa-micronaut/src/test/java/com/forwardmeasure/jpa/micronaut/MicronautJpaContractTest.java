...
class MicronautJpaContractTest implements TestPropertyProvider {
    ...
    public synchronized Map<String, String> getProperties() {
        ...
        return Map.ofEntries(
                ...
                Map.entry(
                        "jpa.default.entity-scan.packages[3]",
    ...
    void executesTheSameRepositoriesAndServicesThroughMicronaut() {
        try (TenantScope.Scope ignored = tenantScope.open(TENANT)) {
            ...
            boolean present = transactions.executeRead(status ->
    ...
    static class ContractBeans {
        ...
        @Singleton
        ContractOwnedEntityRepository contractRepository(
        ...
        @Singleton
        ContractOwnedEntityService contractService(
                ContractOwnedEntityRepository repository) {
